                    ...
                    <div class="row">
                        <div class="col-lg-2 col-lg-offset-1">
                            <div class="input-group">
                                <input type="text" class="form-control input-lg" name="firstName" placeholder="First Name" value="{{ get('firstName','') }}">
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="input-group">
                                <input type="text" class="form-control input-lg" name="lastName" placeholder="Last Name" value="{{ get('lastName','') }}">
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="input-group">
                                <input type="text"  class="form-control input-lg"name="middleName" placeholder="Middle Name" value="{{ get('middleName','') }}">
                            </div>
                        </div>
                        <div class="col-lg-1">
                            <div class="input-group">
                                <select class="form-control input-lg" name="countyCode">
                        ...
                        <div class="col-lg-2">
                            <div class="input-group">
                                <input type="text" class="form-control input-lg" name="voterID" placeholder="Voter ID" value="{{ get('voterID','') }}">
                            </div>
                        </div>
                        <div class="col-lg-1">
                            <button class="btn btn-primary btn-lg btn-block" type="submit">Lookup</button>
                        </div>
                    </div>
                    </form>
                </div>
